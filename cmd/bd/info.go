...
var versionChanges = []VersionChange{
	{
		...
		Date:    "2026-08-27",
		Changes: []string{
			"FIX: absorb upstream schema repair line through migration 0066, including replay of an ignored lease migration when the migration cursor contradicts the physical schema.",
