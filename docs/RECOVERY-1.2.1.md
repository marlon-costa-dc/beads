# Recovering from the accidental v1.2.1 release

v1.2.0 and v1.2.1 were published by accident, without release testing.
...
## Recommended fix: roll the schema cursor back (~2 minutes)
